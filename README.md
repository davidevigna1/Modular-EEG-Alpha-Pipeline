...
pulizia_segnale
: Applies filters (Notch at 50Hz and Band-pass) to remove electrical noise and isolate relevant frequencies.
estrai_alpha
: Calculates the average power of the Alpha rhythm (8-13 Hz) using Power Spectral Density (PSD) computation.
3. 
graphics.py
